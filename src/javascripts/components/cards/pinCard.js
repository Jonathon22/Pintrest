...
const pinMaker = (pinObject) => {
  ...
  <div class=“card-body”>
    ...
    <a href=“#” id=“${pinObject.firebaseKey}” class=“btn btn-primary update-pin"><i class=“far fa-edit”></i>Update Pin</a>
    <a href=“#” id=“${pinObject.firebaseKey}” class=“btn btn-danger delete-pin”>Delete</a>
  </div>
</div>`;
